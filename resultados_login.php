...
if ($service_id) {
    ...
    // Regular services listing - EXCLUDE services with accepted offers
    $services = [];
    ...
    $sql = "SELECT s.*, u.utilizador as criador_nome 
            ...
            WHERE s.id_servico NOT IN (
                ...
                AND o.status IN ('aceita', 'pago_inicial', 'concluida')
            )";
    ...
    <main class="main-container">
        ...
        <?php else: ?>
            ...
            <div class="page-header">
                ...
                <p>Descubra nossa gama de serviços profissionais disponíveis para contratação</p>
            </div>

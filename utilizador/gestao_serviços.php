            ...
            echo "<tr id='edit-form-{$row['id_servico']}' class='edit-form-container'><td colspan='5'>
                <form action='' method='POST'>
                    ...
                    <select name='categoria' required>
                        <option value='categoria1' " . ($row['categoria'] == 'Serviço Doméstico' ? 'selected' : '') . ">Serviço Doméstico</option>
                        <option value='categoria2' " . ($row['categoria'] == 'Serviços Digitais' ? 'selected' : '') . ">Serviços Digitais</option>
                        <option value='categoria3' " . ($row['categoria'] == 'Assistência Pessoal' ? 'selected' : '') . ">Assistência Pessoal</option>
                        <option value='categoria4' " . ($row['categoria'] == 'Manutenção ' ? 'selected' : '') . ">Manutenção </option>
                        <option value='categoria5' " . ($row['categoria'] == 'Eventos' ? 'selected' : '') . ">Eventos</option>
                        <option value='categoria6' " . ($row['categoria'] == 'Aulas e Treinos' ? 'selected' : '') . ">Aulas e Treinos</option>
                    </select>

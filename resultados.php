...
if ($service_id) {
    ...
    // Regular services listing
    $services = [];
    $searchTerm = isset($_GET['search']) ? trim($_GET['search']) : '';
    $category = isset($_GET['category']) ? trim($_GET['category']) : 'All';

    $sql = "SELECT s.*, u.utilizador as criador_nome FROM servicos s LEFT JOIN utilizadores u ON s.id_utilizador = u.id_utilizadores WHERE 1=1";
    $params = [];
    $types = "";
    ...
    <main class="main-container">
        ...
        <?php else: ?>
            ...
            <div class="page-header">
                ...
                <p>Descubra nossa gama de serviços profissionais adaptados às suas necessidades</p>
            </div>
            ...
            <?php if (empty($services)): ?>
                <div class="no-results">
                    ...
                    <p>Não encontramos serviços que correspondam aos seus critérios de pesquisa.</p>
                </div>
            <?php else: ?>
                    ...
                    foreach ($services as $service): ?>
                        <div class="service-card" style="animation-delay: <?php echo $delay; ?>ms">
                            ...
                            <div class="service-card-content">
                                ...
                                <a href="?id=<?php echo $service['id_servico']; ?>" class="service-card-btn">
                                    Ver Detalhes
                                </a>
                            </div>
                        </div>
    ...
    <script>
        ...
        document.querySelectorAll('.service-card-btn').forEach(btn => {
            btn.addEventListener('click', function(e) {
                ...
                showNotification(`Carregando detalhes de: ${serviceName}`, 'info');
            });
        });
